      ...
      <div className=" p-5">
        <div>
          <span className=" font-semibold text-sm">
            You need to declare <span>{product.qte - product.qteLivreur} </span>
            litige{" "}
          </span>
        </div>
        <div className="flex justify-between items-center w-full mb-4 py-4 ">
          ...
          >
            {" "}
            <span className={currentTab === Tab.NON_RECU ? activeTabClass : ""}>
              {" "}
              Non Reçu{" "}
            </span>
          </div>
        ...
        <div>
          {currentTab === Tab.ENDOMMAGE ? (
            ...
            <DefautEmballage
              ...
              quantity={quantity}
              litigeQuantity={toAddQuantity}
              attachementsDefautEmbalageFiles={attachementsDefautEmbalageFiles}
